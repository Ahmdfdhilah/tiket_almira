      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 ml-0 md:ml-64 pt-16 pb-0">
          <div className="p-6 min-h-full">
            ...
            {/* Page Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">Kelola Bus</h1>
              <p className="mt-1 text-sm text-gray-600">
                Kelola semua armada bus dalam sistem
              </p>
            </div>
...
export default connect(mapStateToProps)(AdminBusesPage);