      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 py-16 md:py-24">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <Link
                  to="/search-results" 
                  className="inline-block px-6 py-3 bg-white text-pink-600 font-bold rounded-lg shadow-md hover:bg-gray-100 transition duration-300"
                >
                  Pesan Sekarang
                </Link>
              </div>
        ...
        <section className="py-16 bg-pink-500 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link
              to="/search-results"
              className="inline-block px-6 py-3 bg-white text-pink-600 font-bold rounded-lg hover:bg-gray-100 transition duration-300"
            >
